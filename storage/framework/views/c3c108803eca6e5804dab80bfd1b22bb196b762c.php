...
<li class="nav-item dropdown">
    ...
    <div class="dropdown-menu">
        ...
        <?php if(!AdminLocation::hasOneLocation() AND $staffLocations): ?>
            <div class="px-3 pb-3">
...
<?php /**PATH /var/www/html/staging/app/admin/views/_partials/top_nav_user_menu.blade.php ENDPATH**/ ?>